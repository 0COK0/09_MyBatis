...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("1. if 확인하기"); // 확인하는걸 눌렀을때 서브메뉴를 보여줄거임
    ...
    private static void ifSubMenu() {
        ...
        do {
            ...
            // 표준 입출력 인트를 입력받을 때
            int no = sc.nextInt();
            // 인트로 받은 no라는 변수로 스위치문 작동
            switch (no) {

                case 1: menuService.selectMenuByPrice(inputPrice()); break;
                case 2: menuService.searchMenu(inputsearhCriteria()); break;
                case 9: return;
            }
        } while (true);
    }
    ...
    private static SearchCriteria inputsearhCriteria() {

    Scanner sc = new Scanner(System.in);
        System.out.print("검색 기준을 입력해주세요(name or 카테고리) : ");
        String condition = sc.nextLine();
        System.out.print("검색어를 입력해주세여 : ");
    ...
    private static void chooseSubMenu() {
        ...
        do {
            ...
            switch (no) {
                case 1: menuService.searchMenuBySuqCategory(inputSupCategoty());
                case 9:return;
    ...
    private static SearchCriteria inputSupCategoty() {
        Scanner sc = new Scanner(System.in);
    ...
    private static void trinSubMenu() {
    ...
    private static SearchCriteria inputAllOrOne() {
        ...
        Scanner sc = new Scanner(System.in);
        System.out.print("검색 조건을 입력하시겟습니까?(예 or 아니요) : ");
        boolean hasSearchValue = "예".equals(sc.nextLine())? true : false;

        SearchCriteria searchCriteria = new SearchCriteria();
        if (hasSearchValue) {
            System.out.print("검색할 메뉴 코드로 입력하세요 : ");
    ...
    private static Map<String, Object> inputSearchCriteriaMap() {
        ...
        Scanner sc = new Scanner(System.in);
        System.out.print("검색할 조건을 입력하세요(category or both or null) : ");
        String condition = sc.nextLine();
