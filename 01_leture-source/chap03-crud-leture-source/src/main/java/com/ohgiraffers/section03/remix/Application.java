...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        MenuController menuController = new MenuController();   //여기로보냄
        do {
            ...
            switch (no) {
                case 1 : menuController.selectAllMenu();break;       // 우선 컨트롤러한테 보냄
    ...
    private static Map<String, String> inputModifyMenu() {
        ...
        String code = sc.nextLine();
        System.out.print("수정할 메뉴 이름를 입력하세요 : ");
        String name = sc.nextLine();
        System.out.print("수정할 메뉴 가격를 입력하세요 : ");
        String price = sc.nextLine();
        System.out.print("수정할 메뉴 카테고리 코드를 입력하세요 : ");
        String categoryCode = sc.nextLine();
